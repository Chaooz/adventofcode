...
class Pathfinding:
    ...
    def HeuristicAstarPathTo(self, pathfindingArea:Matrix, startPosition:Vector2, endPositon:Vector2, pathRuleFunction) -> Vector2List:
        ...
        # Used for debug
        self.debugPathMatrix = pathfindingArea.EmptyCopy("debug path", 0)
        ...
        self.costMatrix = pathfindingArea.EmptyCopy("CostMatrix", -1)
        ...
        while( checkList.len() > 0 and iterations < Pathfinding.MAX_ITERATINS ):
            ...
            for neighbour in self.neighbours:
                ...
                newCost = self.costMatrix.GetPoint(currentNode.position) + heuristicCost
                if oldCost == -1 or newCost < oldCost:
                    ...
                    self.debugPathMatrix.SetPoint(nextPos, pathfindingArea.GetPoint(nextPos))
...
#        debugPathMatrix.Print(0, bcolors.DARK_GREY, "00", "")
    ...
    def HeuristicAstarPathToLong(self, pathfindingArea:Matrix, startPosition:Vector2, endPositon:Vector2, pathRuleFunction) -> Vector2List:
