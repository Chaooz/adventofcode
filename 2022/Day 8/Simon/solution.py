...
unittest_input(solvePuzzle1, showDebug,21, "testinput.txt")
unittest_input(solvePuzzle2, showDebug, 8, "testinput.txt")
unittest_input(solvePuzzle1, showDebug, 1546, "input.txt")
unittest_input(solvePuzzle2, showDebug, 519064, "input.txt")
